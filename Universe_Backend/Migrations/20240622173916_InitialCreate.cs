        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyToPost = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostsMentionedInId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostUser", x => new { x.MentionsId, x.PostsMentionedInId });
                    table.ForeignKey(
                        name: "FK_PostUser_Posts_PostsMentionedInId",
                        column: x => x.PostsMentionedInId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostUser_Users_MentionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MentionsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StoriesMentionedInId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoryUser", x => new { x.MentionsId, x.StoriesMentionedInId });
                    table.ForeignKey(
                        name: "FK_StoryUser_Stories_StoriesMentionedInId",
                        column: x => x.StoriesMentionedInId,
                        principalTable: "Stories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoryUser_Users_MentionsId",
                        column: x => x.MentionsId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostUser_PostsMentionedInId",
                table: "PostUser",
                column: "PostsMentionedInId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryUser_StoriesMentionedInId",
                table: "StoryUser",
                column: "StoriesMentionedInId");
