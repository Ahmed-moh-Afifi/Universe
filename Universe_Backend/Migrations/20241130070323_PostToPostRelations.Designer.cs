...
namespace Universe_Backend.Migrations
{
    ...
    [Migration("20241130070323_PostToPostRelations")]
    partial class PostToPostRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Universe_Backend.Data.Models.Post", b =>
                {
                    ...
                    b.HasOne("Universe_Backend.Data.Models.Post", "ChildPost")
                        .WithMany()
                        .HasForeignKey("ChildPostId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Universe_Backend.Data.Models.Post", "ReplyToPost")
                        .WithMany()
