...
public interface IPostsRepository
{
    ...
    public Task<IEnumerable<PostDTO>> GetPosts(string userId, DateTime? lastDate, int? lastId);
    public Task<IEnumerable<PostDTO>> GetReplies(int postId, DateTime? lastDate, int? lastId);
    ...
    public Task<IEnumerable<PostDTO>> GetFollowingPosts(string userId, DateTime? lastDate, int? lastId);
}