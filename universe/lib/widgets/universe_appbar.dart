...
class UniverseBottomAppBar extends StatefulWidget {
  ...
  @override
  State createState() => _UniverseBottomAppBarState();
}

class _UniverseBottomAppBarState extends State<UniverseBottomAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final BottomAppBarTheme defaults = isMaterial3
        ? _UniverseBottomAppBarDefaultsM3(context)
        : _UniverseBottomAppBarDefaultsM2(context);
...
class _UniverseBottomAppBarClipper extends CustomClipper<Path> {
  final double position2MoveHorizontal;
  const _UniverseBottomAppBarClipper({
  ...
  @override
  bool shouldReclip(_UniverseBottomAppBarClipper oldClipper) {
...
class _UniverseBottomAppBarDefaultsM2 extends BottomAppBarTheme {
  const _UniverseBottomAppBarDefaultsM2(this.context)
      : super(
          elevation: 8.0,
        );
  ...
  @override
  Color? get color => Theme.of(context).bottomAppBarTheme.color;
...
class _UniverseBottomAppBarDefaultsM3 extends BottomAppBarTheme {
  _UniverseBottomAppBarDefaultsM3(this.context)
      : super(
          elevation: 3.0,
          height: 80.0,
